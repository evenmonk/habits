...
class HabitActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        habitToEdit = intent.extras?.getParcelable(HABIT_CREATE)
            ?: savedInstanceState?.getParcelable(HABIT_CREATE)
        ...
        save_habit_button.setOnClickListener{
            ...
            val intent = if (habitPosition == null)
                Intent().putExtra(HABIT_CREATE, newHabit)
            else
                Intent().putExtra(HABIT_CREATE, newHabit)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putParcelable(HABIT_CREATE, getNewHabit())
